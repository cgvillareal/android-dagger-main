 ...
 * @Inject le dice a Dagger como proveer una instancia de este tipo
 * Dagger tambien sabe que UserManager es una dependencia
 */
@ActivityScope /// Scopes this ViewModel to components that use @ActivityScope
